...
MCP server for [beads](https://github.com/signalnine/bd) issue tracker and agentic memory system.
...
### ~~MCP Tools Not Loading in Claude Code~~ (Issue [#346](https://github.com/signalnine/bd/issues/346)) - RESOLVED
