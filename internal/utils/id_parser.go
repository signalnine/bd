...
func ResolvePartialID(ctx context.Context, store *embeddeddolt.EmbeddedDoltStore, input string) (string, error) {
	if store == nil {
...
func ResolvePartialIDs(ctx context.Context, store *embeddeddolt.EmbeddedDoltStore, inputs []string) ([]string, error) {
	var resolved []string
