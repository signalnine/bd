...
func outputDotFormat(ctx context.Context, store *embeddeddolt.EmbeddedDoltStore, issues []*types.Issue) error {
...
func outputFormattedList(ctx context.Context, store *embeddeddolt.EmbeddedDoltStore, issues []*types.Issue, formatStr string) error {
