...
A comprehensive skill for using [beads](https://github.com/signalnine/bd) (bd) issue tracking with Claude Code.
...
- [bd CLI](https://github.com/signalnine/bd) installed (see [INSTALLING.md](https://github.com/signalnine/bd/blob/main/docs/INSTALLING.md))
- A git repository (bd uses git for sync)
- Initialized database (`bd init` in project root)

## Contributing

This skill is maintained at [github.com/signalnine/bd](https://github.com/signalnine/bd) in the `claude-plugin/skills/beads/` directory.
