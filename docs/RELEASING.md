...
2. Add to GitHub at https://github.com/signalnine/bd/settings/secrets/actions
...
Monitor at: https://github.com/signalnine/bd/actions

The release will appear at: https://github.com/signalnine/bd/releases
