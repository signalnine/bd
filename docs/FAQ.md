...
See [GitHub issue #125](https://github.com/signalnine/bd/issues/125) for detailed comparison.
...
- **GitHub Issues**: [Report bugs or request features](https://github.com/signalnine/bd/issues)
- **GitHub Discussions**: [Ask questions](https://github.com/signalnine/bd/discussions)
