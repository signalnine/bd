...
- Constructs URL: `https://github.com/signalnine/bd/releases/download/v{VERSION}/beads_{VERSION}_{platform}_{arch}.{ext}`
...
- [beads repository](https://github.com/signalnine/bd)
